          ...
          <div className="relative py-20">
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              <Link
                ...
                className="rounded-md bg-orange-700 px-4 py-2 text-sm text-white hover:bg-orange-800 cursor-pointer"
              >
          ...
          <div className="grid gap-10 md:grid-cols-2">
            <div>
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                <Link
                  href="/payment?type=event"
                  className="rounded-md bg-black text-white px-4 py-2 text-sm hover:bg-neutral-800 cursor-pointer"
                >
                  Réserver votre place
                </Link>
