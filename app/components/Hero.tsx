...
export default function Hero() {
  return (
    ...
    //           <Link
    //             href={ROUTES.activities}
    //             className="rounded-md bg-amber-600 px-4 py-2.5 text-sm font-medium text-white shadow-sm hover:bg-amber-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/80"
    //           >
    //             Découvrir nos activités
    //           </Link>
    //           <Link
